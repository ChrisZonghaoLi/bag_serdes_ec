...
from serdes_ec.layout.qdr.tap1 import Tap1MainRow
...
def generate(prj, specs, gen_sch=True, run_lvs=False):
    ...
    name_list = [impl_cell]
    temp = temp_db.new_template(params=params, temp_cls=Tap1MainRow, debug=False)
    temp_list = [temp]
...
if __name__ == '__main__':
    with open('specs_test/qdr/tap1_main_row.yaml', 'r') as f:

...
from serdes_ec.layout.analog.qdr.tap1 import Tap1Main
...
def generate(prj, specs, gen_sch=True, run_lvs=False):
    ...
    name_list = [impl_cell]
    temp = temp_db.new_template(params=params, temp_cls=Tap1Main, debug=False)
    temp_list = [temp]
...
if __name__ == '__main__':
    with open('specs_test/qdr/tap1_main.yaml', 'r') as f:
